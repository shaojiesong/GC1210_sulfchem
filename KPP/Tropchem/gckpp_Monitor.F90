...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'CH2Br2         ','CHBr3          ','DHDN           ', & ! index 40 - 42
     'DHDC           ','I2O2           ','MONITA         ', & ! index 43 - 45
     'BENZ           ','CH3I           ','I2O3           ', & ! index 46 - 48
     'PMNN           ','PPN            ','TOLU           ', & ! index 49 - 51
     'BrNO2          ','CH3Br          ','HI             ', & ! index 52 - 54
     'IBr            ','IEPOXD         ','INO            ', & ! index 55 - 57
     'TRO2           ','BRO2           ','IEPOXA         ', & ! index 58 - 60
     'IEPOXB         ','IONITA         ','XRO2           ', & ! index 61 - 63
     'MAP            ','ICl            ','IMAO3          ', & ! index 64 - 66
     'MPN            ','CH2Cl2         ','CHCl3          ', & ! index 67 - 69
     'Cl2O2          ','CH3Cl          ','HNO4           ', & ! index 70 - 72
     'IONO           ','HNO2           ','OIO            ', & ! index 73 - 75
     'RA3P           ','RB3P           ','ETP            ', & ! index 76 - 78
     'XYLE           ','DMS            ','ClNO2          ', & ! index 79 - 81
     'ClOO           ','OClO           ','PAN            ', & ! index 82 - 84
     'RP             ','PP             ','PRPN           ', & ! index 85 - 87
     'ALK4           ','PIP            ','HPALD          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     'R4P            ','ATOOH          ','BrCl           ', & ! index 91 - 93
     'HOI            ','DHPCARP        ','N2O5           ', & ! index 94 - 96
     'C3H8           ','MP             ','MRP            ', & ! index 97 - 99
     'RIPB           ','HC187          ','VRP            ', & ! index 100 - 102
     'IAP            ','HPC52O2        ','Br2            ', & ! index 103 - 105
     'Cl2            ','MOBA           ','HONIT          ', & ! index 106 - 108
     'DHMOB          ','RIPA           ','RIPD           ', & ! index 109 - 111
     'BrSALC         ','ISNP           ','BrSALA         ', & ! index 112 - 114
     'MAOP           ','ETHLN          ','EOH            ', & ! index 115 - 117
     'C2H6           ','INPN           ','MTPA           ', & ! index 118 - 120
     'MTPO           ','NPMN           ','BrNO3          ', & ! index 121 - 123
     'IONO2          ','MOBAOO         ','MVKOO          ', & ! index 124 - 126
     'DIBOO          ','LIMO           ','IPMN           ', & ! index 127 - 129
     'I2             ','GAOO           ','CH3CHOO        ', & ! index 130 - 132
     'MGLYOO         ','MACRNO2        ','ROH            ', & ! index 133 - 135
     'MONITS         ','MGLOO          ','ISOPNB         ', & ! index 136 - 138
     'ISNOHOO        ','H2O2           ','HCOOH          ', & ! index 139 - 141
     'ISNOOB         ','HOBr           ','HOCl           ', & ! index 142 - 144
     'PRN1           ','MONITU         ','IEPOXOO        ', & ! index 145 - 147
     'GLYX           ','ISOPNBO2       ','MVKN           ', & ! index 148 - 150
     'MACROO         ','A3O2           ','PROPNN         ', & ! index 151 - 153
     'MAN2           ','ISNOOA         ','ISOP           ', & ! index 154 - 156
     'PO2            ','ATO2           ','B3O2           ', & ! index 157 - 159
     'MACRN          ','MAOPO2         ','I              ', & ! index 160 - 162
     'ClNO3          ','IO             ','HNO3           ', & ! index 163 - 165
     'BrO            ','ISOPNDO2       ','OLNN           ', & ! index 166 - 168
     'OLND           ','LIMO2          ','R4N1           ', & ! index 169 - 171
     'ACTA           ','RCO3           ','CH2OO          ', & ! index 172 - 174
     'PIO2           ','ISOPND         ','KO2            ', & ! index 175 - 177
     'HBr            ','GLYC           ','HC5OO          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(40) :: SPC_NAMES_2 = (/ &
     'VRO2           ','NMAO3          ','MGLY           ', & ! index 181 - 183
     'ISN1           ','HC5            ','ClO            ', & ! index 184 - 186
     'ACET           ','RIO2           ','MRO2           ', & ! index 187 - 189
     'PRPE           ','INO2           ','HAC            ', & ! index 190 - 192
     'R4O2           ','R4N2           ','HCl            ', & ! index 193 - 195
     'ETO2           ','CH2O           ','MVK            ', & ! index 196 - 198
     'MEK            ','MACR           ','SO2            ', & ! index 199 - 201
     'RCHO           ','Br             ','O3             ', & ! index 202 - 204
     'MO2            ','OH             ','NO3            ', & ! index 205 - 207
     'CO             ','ALD2           ','Cl             ', & ! index 208 - 210
     'MCO3           ','NO             ','HO2            ', & ! index 211 - 213
     'NO2            ','CH4            ','H2             ', & ! index 214 - 216
     'H2O            ','MOH            ','O2             ', & ! index 217 - 219
     'RCOOH          ' /)
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     OH + ALD2 --> 0.05 PCO + 0.05 CH2O + 0.05 CO + 0.95 MCO3 + 0.05 HO2 + H2O                      ', & ! index 40
     ...
     '     R4O2 + NO --> POx + 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.19 MEK + 0.14 RCHO + 0.19', & ! index 52
     '     R4O2 + NO --> POx + R4N2                                                                       ', & ! index 53
     '     R4N1 + NO --> POx + 0.57 CH2O + 0.57 RCHO + 0.86 ALD2 + 2 NO2                                  ', & ! index 54
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '     PO2 + MO2 --> 0.25 ROH + 0.16 HAC + 1.25 CH2O + 0.09 RCHO + 0.5 ALD2 + HO2 + 0.25 MOH          ', & ! index 97
     '    R4O2 + HO2 --> R4P                                                                              ', & ! index 98
     '    R4N1 + HO2 --> R4N2                                                                             ', & ! index 99
     '    ATO2 + HO2 --> 0.85 ATOOH + 0.15 CH2O + 0.15 OH + 0.15 MCO3                                     ', & ! index 100
     '     KO2 + HO2 --> 0.85 ATOOH + 0.15 OH + 0.15 ALD2 + 0.15 MCO3                                     ', & ! index 101
     ...
     '    R4N1 + MO2 --> 0.25 ROH + 0.15 R4O2 + 0.95 CH2O + 0.54 RCHO + 0.38 ALD2 + 0.5 HO2 + NO2 + 0.25 M', & ! index 113
     ...
     '        2 RIO2 --> 0.29 PCO + 0.09 DIBOO + 1.11 HC5 + 0.75 CH2O + 0.45 MVK + 0.29 MACR + 0.29 CO + 0', & ! index 117
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    PRN1 + MO2 --> 0.25 ROH + 1.25 CH2O + 0.25 RCHO + 0.5 ALD2 + 0.5 HO2 + NO2 + 0.25 MOH           ', & ! index 124
     ...
     '    MCO3 + HO2 --> 0.15 POx + 0.41 MAP + 0.15 ACTA + 0.15 O3 + 0.44 MO2 + 0.44 OH                   ', & ! index 132
     '    RCO3 + HO2 --> 0.15 POx + 0.41 RP + 0.44 ETO2 + 0.15 O3 + 0.44 OH + 0.15 RCOOH                  ', & ! index 133
     '   NMAO3 + HO2 --> 0.15 POx + 0.39 PCO + 0.41 MAOP + 0.59 CH2O + 0.15 O3 + 0.39 MO2 + 0.44 OH + 0.39', & ! index 134
     '     PRPE + OH --> PO2                                                                              ', & ! index 135
     '     PRPE + O3 --> LOx + 0.56 PCO + 0.12 CH3CHOO + 0.12 CH2OO + 0.5 CH2O + 0.28 MO2 + 0.36 OH + 0.56', & ! index 136
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '      HAC + OH --> 0.5 CO2 + 0.5 PCO + 0.5 HCOOH + 0.5 ACTA + 0.5 MO2 + OH + 0.5 CO                 ', & ! index 152
     '   A3O2 + MCO3 --> RCHO + MO2 + HO2                                                                 ', & ! index 153
     '    PO2 + MCO3 --> CH2O + MO2 + ALD2 + HO2                                                          ', & ! index 154
     ...
     '      MVK + O3 --> LOx + 0.56 PCO + 0.12 MGLOO + 0.12 CH2OO + 0.5 MGLY + 0.6 CH2O + 0.36 OH + 0.56 C', & ! index 158
     '     MACR + O3 --> LOx + 0.625 PCO + 0.022 MGLYOO + 0.326 CH2OO + 0.88 MGLY + 0.12 CH2O + 0.239 OH +', & ! index 159
     ...
     '      ETP + OH --> 0.36 ETO2 + 0.64 OH + 0.64 ALD2                                                  ', & ! index 170
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4O2 + MCO3 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.19 MEK + 0.13 RCHO + MO2 + 0.32', & ! index 207
     '   ATO2 + MCO3 --> CH2O + MO2 + MCO3                                                                ', & ! index 208
     '    KO2 + MCO3 --> MO2 + ALD2 + MCO3                                                                ', & ! index 209
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   R4N1 + MCO3 --> 0.3 R4O2 + 0.39 CH2O + 0.57 RCHO + MO2 + 0.75 ALD2 + NO2                         ', & ! index 215
     ...
     '   PRN1 + MCO3 --> CH2O + MO2 + ALD2 + NO2                                                          ', & ! index 218
     ...
     '   ETO2 + MCO3 --> MO2 + ALD2 + HO2                                                                 ', & ! index 231
     ...
     '   ISOPND + O3 --> 0.63 CO2 + LOx + 0.26 ETHLN + 0.09 EOH + 0.06 GLYX + 0.38 PROPNN + 0.3 HNO3 + 0.2', & ! index 239
     '      DMS + OH --> CH2O + SO2 + MO2                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_8 = (/ &
     ...
     '      SO2 + OH --> SO4 + SO4P0 + PSO4 + HO2                                                         ', & ! index 243
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '    CH3Cl + Cl --> PCO + 2 HCl + CO + HO2                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     '   CH2Cl2 + Cl --> PCO + HCl + CO + 2 Cl + HO2                                                      ', & ! index 301
     '    CHCl3 + Cl --> PCO + HCl + CO + 3 Cl + HO2                                                      ', & ! index 302
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '   CH2OO + SO2 --> SO4 + SO4P0 + PSO4 + CH2O                                                        ', & ! index 380
     ...
     '  MACROO + SO2 --> SO4 + SO4P0 + PSO4 + MACR                                                        ', & ! index 386
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_13 = (/ &
     ...
     '   MVKOO + SO2 --> SO4 + SO4P0 + PSO4 + MVK                                                         ', & ! index 392
     ...
     '  MGLYOO + SO2 --> SO4 + SO4P0 + PSO4 + MGLY                                                        ', & ! index 397
     ...
     '   MGLOO + SO2 --> SO4 + SO4P0 + PSO4 + MGLY                                                        ', & ! index 402
     ...
     ' CH3CHOO + NO2 --> POx + NO3 + ALD2                                                                 ', & ! index 407
     ' CH3CHOO + SO2 --> SO4 + SO4P0 + PSO4 + ALD2                                                        ', & ! index 408
     ...
     '    GAOO + SO2 --> SO4 + SO4P0 + PSO4 + GLYC                                                        ', & ! index 414
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     ...
     '    MTPA + NO3 --> 2 LOx + 0.1 OLNN + 0.9 OLND                                                      ', & ! index 436
     '    MTPO + NO3 --> 2 LOx + 0.1 OLNN + 0.9 OLND                                                      ', & ! index 437
     '     LIMO + OH --> LIMO2                                                                            ', & ! index 438
     '     LIMO + O3 --> LOx + 0.14 PCO + 0.02 PH2O2 + 0.02 H2O2 + 0.01 HCOOH + 0.42 KO2 + 0.46 PRPE + 0.1', & ! index 439
     '    LIMO + NO3 --> 2 LOx + 0.5 OLNN + 0.5 OLND                                                      ', & ! index 440
     '    LIMO2 + NO --> 0.78 POx + 0.22 MONITU + 0.289 PRPE + 0.058 HAC + 0.231 CH2O + 0.289 MEK + 0.491 ', & ! index 441
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_15 = (/ &
     ...
     '   OLNN + OLND --> 0.5 POx + 1.05 MONITS + 0.45 MONITU + 0.202 CH2O + 0.149 MEK + 0.64 RCHO + 0.5 HO', & ! index 458
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '   BrNO3 + H2O --> HOBr + HNO3                                                                      ', & ! index 482
     '   BrNO3 + HCl --> LOx + BrCl + HNO3                                                                ', & ! index 483
     '   ClNO3 + H2O --> HOCl + HNO3                                                                      ', & ! index 484
     '   ClNO3 + HCl --> LOx + Cl2 + HNO3                                                                 ', & ! index 485
     '   ClNO3 + HBr --> LOx + BrCl + HNO3                                                                ', & ! index 486
     'BrSALA + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 487
     'BrSALC + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 488
     '    HOCl + HCl --> LOx + Cl2 + H2O                                                                  ', & ! index 489
     '    HOCl + HBr --> LOx + BrCl + H2O                                                                 ', & ! index 490
     '    HOBr + HBr --> LOx + Br2 + H2O                                                                  ', & ! index 491
     '    HOBr + HCl --> LOx + BrCl + H2O                                                                 ', & ! index 492
     '          HOBr --> LOx + BrCl + H2O                                                                 ', & ! index 493
     ' BrSALA + HOBr --> LOx + Br2                                                                        ', & ! index 494
     ' BrSALC + HOBr --> LOx + Br2                                                                        ', & ! index 495
     '          HOBr --> SO4H1 + LOx + HBr                                                                ', & ! index 496
     '          HOBr --> SO4H2 + LOx + HBr                                                                ', & ! index 497
     '           HCl --> O2                                                                               ', & ! index 498
     '           HCl --> O2                                                                               ', & ! index 499
     '      HBr + O3 --> HOBr                                                                             ', & ! index 500
     '   BrSALA + O3 --> HOBr                                                                             ', & ! index 501
     '   BrSALC + O3 --> HOBr                                                                             ', & ! index 502
     '           HBr --> BrSALA                                                                           ', & ! index 503
     '           HBr --> BrSALC                                                                           ', & ! index 504
     '            HI --> AERI                                                                             ', & ! index 505
     '            HI --> ISALA                                                                            ', & ! index 506
     '            HI --> ISALC                                                                            ', & ! index 507
     '           HOI --> ISALA + LOx                                                                      ', & ! index 508
     '           HOI --> ISALC + LOx                                                                      ', & ! index 509
     '          I2O2 --> 2 AERI + 2 LOx                                                                   ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_17 = (/ &
     '          I2O2 --> 2 ISALA + 2 LOx                                                                  ', & ! index 511
     '          I2O2 --> 2 ISALC + 2 LOx                                                                  ', & ! index 512
     '          I2O3 --> 2 AERI + 3 LOx                                                                   ', & ! index 513
     '          I2O3 --> 2 ISALA + 3 LOx                                                                  ', & ! index 514
     '          I2O3 --> 2 ISALC + 3 LOx                                                                  ', & ! index 515
     '          I2O4 --> 2 AERI + 4 LOx                                                                   ', & ! index 516
     '          I2O4 --> 2 ISALA + 4 LOx                                                                  ', & ! index 517
     '          I2O4 --> 2 ISALC + 4 LOx                                                                  ', & ! index 518
     '          IONO --> ISALA + LOx                                                                      ', & ! index 519
     '          IONO --> ISALC + LOx                                                                      ', & ! index 520
     '         IONO2 --> ISALA + 2 LOx                                                                    ', & ! index 521
     '         IONO2 --> ISALC + 2 LOx                                                                    ', & ! index 522
     '          IONO --> LOx + 0.15 IBr + 0.85 ICl + HNO2                                                 ', & ! index 523
     '         IONO2 --> LOx + 0.15 IBr + 0.85 ICl + HNO3                                                 ', & ! index 524
     '           HOI --> LOx + 0.15 IBr + 0.85 ICl                                                        ', & ! index 525
     ...
     '        ISOPND --> LOx + IONITA                                                                     ', & ! index 534
     '        ISOPNB --> LOx + IONITA                                                                     ', & ! index 535
     '         MACRN --> LOx + IONITA                                                                     ', & ! index 536
     '          MVKN --> LOx + IONITA                                                                     ', & ! index 537
     '          R4N2 --> LOx + IONITA                                                                     ', & ! index 538
     '          DHDN --> IONITA                                                                           ', & ! index 539
     '        MONITS --> MONITA                                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_18 = (/ &
     '        MONITU --> MONITA                                                                           ', & ! index 541
     '         HONIT --> MONITA                                                                           ', & ! index 542
     '            O3 --> LOx + 2 OH                                                                       ', & ! index 543
     '            O3 --> LOx + OH + HO2                                                                   ', & ! index 544
     '           NO2 --> O3 + NO                                                                          ', & ! index 545
     '          H2O2 --> 2 OH                                                                             ', & ! index 546
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_19 = (/ &
     ...
     '          INPN --> RCHO + OH + HO2 + NO2                                                            ', & ! index 574
     '          PRPN --> RCHO + OH + HO2 + NO2                                                            ', & ! index 575
     '           ETP --> OH + ALD2 + HO2                                                                  ', & ! index 576
     '          RA3P --> RCHO + OH + HO2                                                                  ', & ! index 577
     '          RB3P --> ACET + OH + HO2                                                                  ', & ! index 578
     '           R4P --> RCHO + OH + HO2                                                                  ', & ! index 579
     '            PP --> CH2O + OH + ALD2 + HO2                                                           ', & ! index 580
     '            RP --> OH + ALD2 + HO2                                                                  ', & ! index 581
     '          RIPA --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 OH + 0.985 HO', & ! index 582
     '          RIPB --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 OH + 0.985 HO', & ! index 583
     '          RIPD --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 OH + 0.985 HO', & ! index 584
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + OH + 0.67 CO + HO2 + 0.19 H2       ', & ! index 585
     '          ISNP --> RCHO + OH + HO2 + NO2                                                            ', & ! index 586
     ...
     '          R4N2 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.32 ETO2 + 0.19 MEK + 0.13 RCHO + 0.18 MO2 +', & ! index 590
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_20 = (/ &
     ...
     '         CH3Br --> Br + MO2                                                                         ', & ! index 603
     '         CH3Cl --> MO2 + Cl                                                                         ', & ! index 604
     '        CH2Cl2 --> 2 Cl                                                                             ', & ! index 605
     '          BrCl --> Br + Cl                                                                          ', & ! index 606
     '           Cl2 --> 2 Cl                                                                             ', & ! index 607
     '           ClO --> O3 + Cl                                                                          ', & ! index 608
     '          OClO --> ClO + O3                                                                         ', & ! index 609
     '         Cl2O2 --> 2 LOx + ClOO + Cl                                                                ', & ! index 610
     '         ClNO2 --> Cl + NO2                                                                         ', & ! index 611
     '         ClNO3 --> NO3 + Cl                                                                         ', & ! index 612
     '         ClNO3 --> ClO + NO2                                                                        ', & ! index 613
     '          HOCl --> LOx + OH + Cl                                                                    ', & ! index 614
     '          ClOO --> Cl + O2                                                                          ', & ! index 615
     '            I2 --> 2 I                                                                              ', & ! index 616
     '           HOI --> LOx + I + OH                                                                     ', & ! index 617
     '            IO --> I + O3                                                                           ', & ! index 618
     '           OIO --> 2 LOx + I + O2                                                                   ', & ! index 619
     '           INO --> I + NO                                                                           ', & ! index 620
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(15) :: EQN_NAMES_21 = (/ &
     '           ICl --> I + Cl                                                                           ', & ! index 631
     '           MPN --> POx + CH2O + NO3 + HO2                                                           ', & ! index 632
     '           MPN --> MO2 + NO2                                                                        ', & ! index 633
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', & ! index 634
     '        PROPNN --> PCO + CH2O + MO2 + CO + NO2                                                      ', & ! index 635
     '         ATOOH --> CH2O + OH + MCO3                                                                 ', & ! index 636
     '           PIP --> RCHO + OH + HO2                                                                  ', & ! index 637
     '          IPMN --> 0.4 CO2 + 0.4 POx + 0.6 IMAO3 + 0.4 CH2O + 0.4 NO3 + 0.4 MCO3 + 0.6 NO2          ', & ! index 638
